...
| upload_root   | Root where uploaded files will be stored.                                                 | absolute or relative path               | `uploaded_root: /some/dir;`                       |
...
You can log requests and responses by specifying `debug=on` in your configuration file.
